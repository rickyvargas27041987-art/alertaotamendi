...
const PRIORIDAD_CATEGORIA: Record<
  string,
  number
> = {
  Emergencia: 1,
...
/*
 * Solamente estos estados permanecen
 * visibles en el mapa operativo.
 *
 * Resuelta y descartada desaparecen.
 */
function esActiva(
  status: string
) {
...
export default function AdminPage() {
  ...
  async function changeStatus(
    ...
    try {
       ...
       * del refresco automático.
       *
       * Al pasar a RESUELTA o
       * DESCARTADA, mapReports cambia
       * inmediatamente y desaparece
       * el marcador.
       */
      ...
      /*
       * Una alerta resuelta o
       * descartada deja de contar
       * como crítica sin revisar.
       */
      if (
        status ===
          "resuelta" ||
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="mx-auto max-w-[1600px] px-4 py-5 sm:px-6 lg:px-8">
        ...
        <section className="mb-5 grid gap-4 xl:grid-cols-[250px_minmax(0,1fr)_310px]">
          ...
          <aside className="space-y-3">
            ...
            <div className="rounded-3xl border border-red-500/30 bg-red-950/35 p-4">
            ...
            <div className="grid grid-cols-2 gap-3 xl:grid-cols-1">
              ...
              <div className="rounded-3xl border border-orange-500/25 bg-orange-950/25 p-4">
              ...
              <div className="rounded-3xl border border-yellow-500/25 bg-yellow-950/20 p-4">
            ...
            <div className="rounded-3xl border border-slate-800 bg-slate-900 p-4 text-xs text-slate-400">
          ...
          <aside className="rounded-3xl border border-slate-800 bg-slate-900/80 p-4">
            ...
            <div className="mb-3 flex items-center justify-between gap-2">
              ...
              <span className="rounded-full bg-slate-950 px-2 py-1 text-[11px] text-slate-400">
                Top 5
              </span>
