...
export default function AdminPage() {
  ...
  const mapReports = useMemo(() => {
    ...
    return reports.filter((report) => {
      ...
      const diffHours =
        (current - new Date(report.createdAt).getTime()) / (1000 * 60 * 60);
          ...
          <aside className="rounded-3xl border border-slate-800 bg-slate-900/80 p-4">
            <div className="mb-3 flex items-center justify-between gap-2">
              <div>
                ...
                <h2 className="text-lg font-black">Prioridad inmediata</h2>
              </div>
            ...
            <div className="space-y-2">
              ...
              {attentionReports.map((report) => (
                ...
                >
                  ...
                  <p className="mt-2 line-clamp-2 text-xs text-slate-400">{report.description}</p>
