...
export default function MapaPublicoPage() {
  ...
  /*
   * IMPORTANTE:
   * Cargamos Leaflet solamente en el navegador.
   * Así Next/Vercel no intenta ejecutar código que utiliza "window"
  ...
  useEffect(() => {
    ...
    import("../components/MapaAlertas")
      ...
      .catch((error) => {
        console.error(
          "Error cargando componente del mapa:",
          error
        );
      });
  ...
  /*
   * Actualizamos las alertas automáticamente.
   */
  useEffect(() => {
    void cargarAlertas();
  ...
  /*
   * MAPA PÚBLICO:
   * solamente mostramos alertas activas
   * creadas durante las últimas 2 horas.
   *
   * NO se borran de la base de datos.
   * El administrador conserva todo el historial.
   */
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="mx-auto max-w-6xl px-4 py-5 sm:px-6">
        ...
        <div className="mb-4 flex items-center justify-between gap-3 rounded-2xl border border-slate-800 bg-slate-900 px-4 py-3">
          ...
          <div>
            ...
            <p className="mt-1 text-xs leading-5 text-slate-400">
              El mapa intenta ubicarte
              automáticamente y mostrar
          ...
          <div className="flex min-h-[430px] items-center justify-center rounded-3xl border border-slate-800 bg-slate-900 p-12 text-center">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-slate-500">
                Obteniendo alertas recientes
                y preparando tu ubicación.
              </p>
            </div>
        ...
        <div className="mt-4 rounded-2xl border border-slate-800 bg-slate-900 p-4 text-xs leading-5 text-slate-400">
          🔒 Por seguridad, el mapa comunitario
          muestra ubicaciones aproximadas y
          únicamente alertas recientes.
          Podés alejar el mapa manualmente para
          explorar otras zonas.
          Las descripciones completas,
          fotografías, videos y audios quedan
          reservados para el Centro de Monitoreo.
        </div>
